...
function displayRooms(habitaciones) {
  ...
  habitaciones.forEach(habitacion => {
    ...
    roomCard.innerHTML = `
      <img src="../assets/images/${habitacion}.jpg" alt="${habitacion.nombre}" />
...
function showRoomDetail(habitacion) {
  ...
  roomInfo.innerHTML = `
    ...
    <img src="./assets/${habitacion.numero}.jpg" alt="${habitacion.nombre}" />
...
async function loadRoom() {
  const habitaciones = await getRoomData();
  console.log("Habitaciones cargadas:", habitaciones); // útil para debug
